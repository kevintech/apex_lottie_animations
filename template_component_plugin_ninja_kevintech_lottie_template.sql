...
--   Date and Time:   19:09 Sunday August 25, 2024 --   
...
'',
'  window.ninja_kevintech_lottie_template = () => {',
'    apex.debug.info(`Lottie Template Component: Initializing Lottie Animation Plug-In`);',
...
'    });',
'',
'    let templateEl = document.getElementById(''#ELEMENT_ID#'').parentElement;',
'',
'    if (!templateEl.getAttribute(''id'') && templateEl.tagName == ''A-PARTIAL'') {',
'      templateEl = templateEl.parentElement;',
'    }',
'    templateEl.lottie = dotLottie;',
'    templateEl.dataset.lottie = ''TEMPLATE'';',
'',
'    window.ninja_kevintech_lottie_template.play = (id) => {',
'      apex.debug.info(`Lottie Template Component: Playing Animation`);',
'      if (!id) {',
'        dotLottie.play();',
'        return;',
'      }',
'',
'      let myLottie = document.getElementById(id).lottie;',
'      if (!myLottie) return;',
'      myLottie.play();',
'    }',
'',
'    window.ninja_kevintech_lottie_template.pause = (id) => {',
'      apex.debug.info(`Lottie Template Component: Pausing Animation`);',
'      if (!id) {',
'        dotLottie.pause();',
'        return;',
'      }',
...
'    }',
'',
'    window.ninja_kevintech_lottie_template.stop = (id) => {',
'      apex.debug.info(`Lottie Template Component: Stopping Animation`);',
'      if (!id) {',
'        dotLottie.stop();',
'        return;',
'      }',
...
'  }',
'',
'  ninja_kevintech_lottie_template();',
'</script>'))
